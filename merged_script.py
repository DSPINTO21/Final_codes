...
# Load your data
file_path = '/home/saif/final_codes/output/gps_test9.csv'  # Replace with the path to your CSV file
...
def convert_images_to_pdf_with_custom_text_and_font(image_files, texts, font_sizes, output_pdf):
    ...
    for i, file in enumerate(image_files):
        ...
        # Only add text from the second image onwards
        if i > 0:
            draw = ImageDraw.Draw(img)
            font_path = "/usr/share/fonts/truetype/freefont/FreeSans.ttf"  # Ensure this path is correct
...
image_files = ['output_image_a4_size.png', 'Tree_width.png', 'Tree_height.png', 'Distribution.png', 
